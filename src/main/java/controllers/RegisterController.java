...
public class RegisterController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            if (username.isEmpty() || email.isEmpty()  || password.isEmpty() || re_pass.isEmpty()) {
                request.setAttribute("mess", "Please fill in all the fields");
                RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/register.jsp");
                dispatch.forward(request, response);
            } else if (!password.equals(re_pass)) {
                request.setAttribute("notmat", "Passwords do not match");
                RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/register.jsp");
                dispatch.forward(request, response);
                } else {
