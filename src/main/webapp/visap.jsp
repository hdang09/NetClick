        ...
        <main class="text-black dark:text-white p-6 max-w-7xl mx-auto">
            ...
            <div class="flex-grow">
                <div class="flex justify-center items-center mt-10 mb-0">
                    <h1 class="text-6xl md:text-7xl font-light mb-8 px-3">Set up your credit</h1>
                </div>
                    ...
                    <div class="w-full">
                        <div class="max-w-md">
                            ...
                            <form action="/Payment" method="POST" class="space-y-4">
                                ...
                                <div>
                                    <label for="cardNumber" class="block text-gray-800 dark:text-white font-semibold">Card Number</label>
                                    <input
                                        id="cardNumber"
                                        name="visa"
                                        type="number"
                                ...
                                <div class="flex space-x-4">
                                    <div class="w-1/2">
                                        <label for="expiryDate" class="block text-gray-800 dark:text-white font-semibold">Expire Date</label>
                                        <input
                                            id="expiryDate"
                                            name="expiredate"
                                            type="date"
                                ...
                                <div>
                                    <label for="cardHolder" class="block text-gray-800 dark:text-white font-semibold">Name</label>
                                    <input
                                        id="cardHolder"
                                        type="text"
                                ...
                                <div class="flex justify-between items-center">
                                    <div class="flex items-center">
                                        <input
                                            ...
                                            />
                                        <label for="saveCard" class="ml-2 block text-gray-800 dark:text-white">Save information</label>
                                    </div>
                                    <button
                                        type="submit"
