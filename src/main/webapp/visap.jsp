<%@page contentType="text/html" pageEncoding="UTF-8"%> <%@ include file="components/imports.jsp" %>
<!DOCTYPE html>
<html class="h-full">
  <head>
  ...
  <!-- header -->
  <header>
    <div class="flex container m-0 px-6 py-6"></div>
  </header>
  ...
  <body class="flex flex-col h-full">
    ...
    <div class="flex justify-between items-center">
      <a
        href="#"
        class="flex items-center font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80 p-2 rounded-full absolute top-6 right-6"
      >
    ...
    <footer class="inline-block w-screen bg-gray-800">
      <div class="flex items-center justify-center mt-4 mb-2">
        <a
          href="#"
          class="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center mr-2 transition-opacity duration-300 hover:bg-opacity-50"
        >
