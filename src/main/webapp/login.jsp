              ...
              <div class="px-20 md:px-0 lg:w-6/12">
                ...
                <div class="md:mx-6 md:p-20">
                  ...
                  <div class="flex items-center">
                      <a class="mx-auto" href="index.jsp"><img src="assets/favicon.png" alt="Logo" class="h-20"></a>
                </div>
                  <div class=" sticky w-full flex justify-center items-center mt-2">
                    ...
                    <div>
                      <h2 class="flex bg-blue-500 rounded text-4xl text-white font-light pb-2 mb- mt-10 px-3">NetClick</h2>
                    </div>
                  </div>
                  ...
                  <div class="relative mb-4" data-te-input-wrapper-init>
                    <input
                      type="text"
                      class="peer block min-h-[auto] w-full rounded border-0 bg-slate-50 px-3 py-[0.32rem] 
                    ...
                    <div class="mb-12 pb-1 pt-1 pb-4 mb-auto text-center">
                      <button
                        class="mb-3 inline-block w-full px-6 pb-2 pt-2.5 text-lg uppercase
                    ...
                    <div class="flex items-center justify-between pb-6">
                      ...
                      <button
                        type="button"
                        class="inline-block border-2 border-danger px-6 pb-[6px] pt-2 text-xs font-medium tracking-wide text-gray-600 hover:text-white capitalize
                        transition-colors duration-300 transform bg-blue-white rounded-lg hover:bg-blue-600 
                        focus:outline-none focus:ring focus:ring-white focus:ring-opacity-50"> <a href="/register.jsp">
                        Register</a>
                      </button>
                    </div>
                  </form>
