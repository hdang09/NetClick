...
<aside class="w-60 h-screen border-r-2 pl-8 pt-4">
  ...
  <div class="mt-8">
    ...
    <a href="/new-movies" class="my-5 flex items-center text-red-700 text-lg border-r-4 border-red-700">
  ...
  <div class="mt-8">
    ...
    <a href="/movie?tag=action" class="my-5 flex items-center text-gray-400 text-lg">
      <i class="fa-solid fa-film"></i>
      <span class="ml-3 font-bold">Action</span>
    </a>
    <a href="/movie?tag=adventure" class="my-5 flex items-center text-gray-400 text-lg">
      <i class="fa-solid fa-film"></i>
      <span class="ml-3 font-bold">Adventure</span>
    </a>
    <a href="/movie?tag=documetaries" class="my-5 flex items-center text-gray-400 text-lg">
      <i class="fa-solid fa-film"></i>
      <span class="ml-3 font-bold">Classic</span>
    </a>
    <a href="/movie?tag=comedies" class="my-5 flex items-center text-gray-400 text-lg">
      <i class="fa-solid fa-film"></i>
    ...
    <a href="/movie?tag=horror" class="my-5 flex items-center text-gray-400 text-lg">
      <i class="fa-solid fa-film"></i>
  ...
  <div class="mt-8">
    ...
    <a href="/" class="my-5 flex items-center text-gray-400 text-lg">
