...
<header class="dark:text-white z-10 py-6 transition duration-250 ease-in">
    <div class="max-w-7xl m-auto flex justify-between items-center px-4">
        <%-- Logo --%>
        ...
        <nav class="hidden lg:block">
            <ul class="flex w-96 justify-between uppercase font-semibold mr-32 transition duration-250 ease-in">
